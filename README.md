...
* [editly](https://github.com/mifi/editly) ⭐ 5,477 | 🐛 80 | 🌐 TypeScript | 📅 2025-05-12 - Declarative video editing tool and library with slick animations and transitions.
...
* [ijkplayer](https://github.com/Bilibili/ijkplayer) ⭐ 33,198 | 🐛 2,897 | 🌐 C | 📅 2024-08-13 - Android / iOS video player based on FFmpeg.
...
* [Learn FFmpeg libav the Hard Way](https://github.com/leandromoreira/ffmpeg-libav-tutorial) ⭐ 11,038 | 🐛 42 | 🌐 C | 📅 2026-06-18
