...
* [CLI flags](https://github.com/transitive-bullshit/ffmpeg-cli-flags/blob/master/readme.md) ⭐ 52 | 🐛 1 | 📅 2020-07-11 - A comprehensive list of all FFmpeg commandline flags. Really useful for searching random flags that you come across in the wild.
...
* [editly](https://github.com/mifi/editly) ⭐ 5,507 | 🐛 80 | 🌐 TypeScript | 📅 2025-05-12 - Declarative video editing tool and library with slick animations and transitions.
...
* [ffmpeg-static](https://github.com/eugeneware/ffmpeg-static) ⭐ 1,397 | 🐛 34 | 🌐 JavaScript | 📅 2026-03-21 - Provides static FFmpeg binaries for macOS, Linux, and Windows. Very useful for CI testing.
...
* [ffmpeg-probe](https://github.com/transitive-bullshit/ffmpeg-probe) ⭐ 16 | 🐛 11 | 🌐 JavaScript | 📅 2023-01-25 - Wrapper around ffprobe for getting info about media files.
...
* [lottie-render](https://github.com/steven-panxd/lottie-render) ⭐ 2 | 🐛 0 | 🌐 TypeScript | 📅 2026-09-23 - Converts Lottie animations to MP4 using Playwright and FFmpeg, as a library or self-hosted HTTP service.
* [tangerine](https://github.com/niftylettuce/tangerine) - Webcam streaming service using Node.js, FFmpeg, WebSockets, and Lad.

## Native

* [ffmpeg-gl-transition](https://github.com/transitive-bullshit/ffmpeg-gl-transition) ⭐ 719 | 🐛 36 | 🌐 C | 📅 2024-07-23 - FFmpeg filter for applying GLSL transitions between video streams ([gl-transitions](https://gl-transitions.com/)).

## Mobile

* [ijkplayer](https://github.com/Bilibili/ijkplayer) ⭐ 33,209 | 🐛 2,901 | 🌐 C | 📅 2024-08-13 - Android / iOS video player based on FFmpeg.
...
* [A Beginner's FFmpeg Cookbook](https://github.com/talwrii/ffmpeg-cookbook) ⭐ 104 | 🐛 1 | 📅 2025-07-15
