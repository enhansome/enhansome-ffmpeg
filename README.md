...
* [editly](https://github.com/mifi/editly) ⭐ 5,485 | 🐛 80 | 🌐 TypeScript | 📅 2025-05-12 - Declarative video editing tool and library with slick animations and transitions.
...
* [ffmpeg-static](https://github.com/eugeneware/ffmpeg-static) ⭐ 1,389 | 🐛 34 | 🌐 JavaScript | 📅 2026-03-21 - Provides static FFmpeg binaries for macOS, Linux, and Windows. Very useful for CI testing.
...
* [ijkplayer](https://github.com/Bilibili/ijkplayer) ⭐ 33,202 | 🐛 2,898 | 🌐 C | 📅 2024-08-13 - Android / iOS video player based on FFmpeg.
...
* [FFmpeg Cheatsheet for Video Automation](https://github.com/rendi-api/ffmpeg-cheatsheet) ⭐ 1,739 | 🐛 1 | 📅 2026-04-29
