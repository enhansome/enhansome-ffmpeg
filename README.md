...
* [editly](https://github.com/mifi/editly) ⭐ 5,478 | 🐛 80 | 🌐 TypeScript | 📅 2025-05-12 - Declarative video editing tool and library with slick animations and transitions.
* [ffmpeg.js](https://github.com/Kagami/ffmpeg.js) ⭐ 3,460 | 🐛 82 | 🌐 JavaScript | 📅 2023-11-04 - Port of FFmpeg to JavaScript via Emscripten. Allows for limited FFmpeg use on the client-side.
...
* [ffmpeg-concat](https://github.com/transitive-bullshit/ffmpeg-concat) ⭐ 987 | 🐛 53 | 🌐 JavaScript | 📅 2026-01-24 - Concats a list of videos together using FFmpeg with sexy OpenGL transitions.
...
* [ijkplayer](https://github.com/Bilibili/ijkplayer) ⭐ 33,200 | 🐛 2,897 | 🌐 C | 📅 2024-08-13 - Android / iOS video player based on FFmpeg.
